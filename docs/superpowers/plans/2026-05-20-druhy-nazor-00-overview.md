...
- `04-privacy-polish.md` — **written and implemented.** Pre-send confirmation modal, onboarding screens, error states, history UI, hotkey remapping, accessibility (VoiceOver/NVDA), high-contrast mode. Also retrofits the CLI provider (built after M2, outside any plan) into this coverage table.
...
| First-run onboarding                      | `04-privacy-polish.md` Task 3 (`Onboarding.svelte`, `src/lib/onboarding.ts`)                                                                                                                                                        |
| Actionable error states                   | `04-privacy-polish.md` Task 1 (`ErrorCode` in `src-tauri/src/error.rs`, `src/lib/errors.ts`, `ErrorState.svelte`)                                                                                                                   |
| History view                              | `04-privacy-polish.md` Task 4 (storage + commands), Task 5 (`src/routes/history/+page.svelte`)                                                                                                                                      |
| History retention and deletion            | `04-privacy-polish.md` Task 4 (`history_retention_days`, startup prune), Task 5 (delete / clear-all UI)                                                                                                                             |
| Hotkey remapping in Settings              | `04-privacy-polish.md` Task 6 (`HotkeyInput.svelte`, `hotkey::{normalize,reinstall}`)                                                                                                                                               |
| Accessibility + high contrast             | `04-privacy-polish.md` Task 7 (`src/lib/contrast.ts` regression test, `data-contrast` palette, claim buttons)                                                                                                                       |
